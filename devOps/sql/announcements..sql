...
CREATE TABLE announcements (
    ...
    announcement_owner_id BIGINT NOT NULL,
    announcement_module_id BIGINT NOT NULL,
...
VALUES ('Welcome to the Internet Application of Engineering class!', '2024-12-03', '09:00:00', 3, 123456),
       ('Welcome to the Robotics club!', '2024-12-04', '13:00:00', 2, 123457);