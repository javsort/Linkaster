...
INSERT INTO private_chats (
    ...
    user2_email, user2_name, user2_public_key, user2_role, user2_id
) VALUES
('user1@example.com', 'User One', 'user1_public_key_123', 'ADMIN', 5,
 'user2@example.com', 'User Two', 'user2_public_key_456', 'TEACHER', 6),
('user3@example.com', 'User Three', 'user3_public_key_789', 'STUDENT', 7,
 'user4@example.com', 'User Four', 'user4_public_key_101112', 'TEACHER', 8),
('user5@example.com', 'User Five', 'user5_public_key_131415', 'ADMIN', 9,
 'user6@example.com', 'User Six', 'user6_public_key_161718', 'STUDENT', 10);